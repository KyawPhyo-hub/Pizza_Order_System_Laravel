            ...
            <div class="col">
                <div class="card">
                    <div class="shadow card-body">
                        <form action="{{ route('customerUpdateProfile') }}" method="post" class="p-3 rounded" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-3">
                                   ...
                                   @else
                                     <img id="output" src="{{ asset('uploads/profileImg/'.auth()->user()->profile) }}" alt="" class="shadow-sm img-thumbnail">
                                   @endif
                                ...
                                <div class="col">
                                   ...
                                   <div class="mt-2 mb-2">
                                    ...
                                    <a class="" href="{{ route('customerChangePasswordPage') }}">Change Password</a>
                                    @endif
                                   </div>
                                   <div class="">
                                    <input type="submit" value="Update" class="mt-3 btn btn-outline-primary">
                                    <a href="{{ route('customerHome') }}" type="button" class="mt-3 btn btn-outline-dark">Back</a>
                                   </div>
