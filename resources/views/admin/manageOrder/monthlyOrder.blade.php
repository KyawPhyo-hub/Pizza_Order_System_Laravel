    ...
    <section id="booking-list" class="section">
        <div class="container">
            <div class="mb-3 text-center section-title">
                <h2>Monthly's Order List</h2>
                <p class="" style="color: #ceaf7f">Click the order code to view order details</p>
            </div>
            {{-- Search bar start --}}
            <form method="GET" action="{{ route('adminMonthlyOrderList') }}" class="mb-3">
                <div class="row g-2 align-items-center">
                    <div class="col-8"></div>
                    <div class="col-auto">
                        <input type="text" name="search" value="{{ $search ?? '' }}" class="form-control"
                            style="width: 300px" placeholder="Search orders…">
                    </div>
                    <div class="col-auto">
                                            ...
                                            <select name="" class=" form-select status" id="">
                                                ...
                                                @elseif($order->delivery_type == 'pickup')
                                                    <option value="pickedup"
                                                        {{ $order->status == 'pickedup' ? 'selected' : '' }}>Pickedup
                                                    </option>
                                                @endif
