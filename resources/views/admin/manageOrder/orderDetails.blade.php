    ...
    <div class="container py-3">
        <div class="container text-center section-title" data-aos="fade-up">
            ...
            @switch($orders->status)
                @case('pending')
                    <p class="text-warning">🕒 “Order is pending and waiting for confirmation.”</p>
                    @break
                @case('confirm')
                    <p class="text-info">✅ “Order has been confirmed and is being prepared.”</p>
                    @break
                @case('ready')
                    <p class="" style="color: orange">🍽️ “Order is ready for pickup or delivery.”</p>
                    @break
                @case('delivered')
                    <p class="text-success">🚚 “Order has been delivered.”</p>
                    @break
                @case('pickedup')
                    <p class="text-success">🏃‍♂️ “Order has been picked up.”</p>
                    @break
                @case('cancel')
                    <p class="text-danger">❌ “Order has been canceled.”</p>
                    @break
                @default
                ...
                <div class="text-black bg-white border border-black rounded">
                    <div class="p-4">
                        <div class="mb-3 d-flex justify-content-between">
                            ...
                            <p class="mb-0" id="subTotal">{{ $order['0']['username'] }}</p>
                        </div>
                        <div class="mb-3 d-flex justify-content-between">
